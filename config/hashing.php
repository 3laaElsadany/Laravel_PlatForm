...
return [
    ...
    */
    ...
    'bcrypt' => [
        ...
        // When true, bcrypt refuses to verify non-bcrypt hashes (e.g. Argon2id from another driver).
        // false uses PHP password_verify(), which accepts any supported algorithm in the stored hash.
