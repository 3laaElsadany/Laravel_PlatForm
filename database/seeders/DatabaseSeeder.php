...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin = User::factory()->admin()->create([
            'fullname' => 'Alaa ElSayed',
            'email' => 'alaaelsayed075544@gmail.com',
            'isVerified' => true,
        ]);

        $students = collect([
            ['fullname' => '3laa', 'email' => 'elsadanyalaa30@gmail.com', 'isVerified' => true, 'country' => 'Egypt', 'language' => 'ar'],
        ...
        foreach ($enrollmentPairs as [$user, $course]) {
            ...
            $final = $pricing->priceAfterCatalogDiscount($course);
